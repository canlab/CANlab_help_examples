...
printstr(dashes)
barplot_columns(DAT.npsresponse, figtitle, 'colors', DAT.colors, 'dolines', 'nofig', 'names', DAT.conditions);
title('NPS - dot product');

subplot(1, 2, 2)
printstr('NPS by condition, cosine similarity')
printstr(dashes)
barplot_columns(DAT.npsresponse_cosinesim, figtitle, 'colors', DAT.colors, 'dolines', 'nofig', 'names', DAT.conditions);
...
barplot_columns(DAT.npscontrasts, figtitle, 'colors', DAT.contrastcolors, 'nofig', 'names', DAT.contrastnames);
