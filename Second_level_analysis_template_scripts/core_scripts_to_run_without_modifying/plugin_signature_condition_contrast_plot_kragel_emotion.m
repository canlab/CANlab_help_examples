...
% DAT.EMO_CAT_SIG_conditions.(data scaling).(similarity metric).(signaturename)
% DAT.EMO_CAT_SIG_contrasts.(data scaling).(similarity metric).(signaturename)
%
...
% table2array(DAT.EMO_CAT_SIG_contrasts.scaled.dotproduct.NPSneg)
%
% DAT.EMO_CAT_SIG_conditions.raw.dotproduct = apply_all_signatures(DATA_OBJ, 'conditionnames', DAT.conditions);
% DAT.EMO_CAT_SIG_contrasts.raw.dotproduct = apply_all_signatures(DATA_OBJ_CON, 'conditionnames', DAT.conditions);
...
for n = 1:nplots
    ...
    mydata = table2array(DAT.EMO_CAT_SIG_conditions.(myscaling).(mymetric).(mysignature));
...
for n = 1:nplots
    ...
    mysignature = signatures_to_plot{n};
    mydata = table2array(DAT.EMO_CAT_SIG_contrasts.(myscaling).(mymetric).(mysignature));
