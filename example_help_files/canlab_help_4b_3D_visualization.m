...
[all_surf_handles, pcl, ncl] = surface(t, 'cutaway', 'ycut_mm', -30);
snapnow

create_figure('cutaways');  axis off
han = surface(t, 'right_cutaway');
snapnow

create_figure('cutaways'); axis off
han = surface(t, 'coronal_slabs');
snapnow
...
surface_handles = t.surface('cutaway', 'ycut_mm', 10, 'pos_colormap', poscm);
snapnow
...
t.surface('surface_handles', surface_handles);
drawnow, snapnow
